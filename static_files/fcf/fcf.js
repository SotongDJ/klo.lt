final_title_str="klo.lt - FCF《斐姨所思》播放室";
final_root_path="https://klo.lt/fcf/";
final_artist_str="范琪斐";
channel="fcf";

document.getElementById("aboutA").href="https://github.com/SotongDJ/klo.lt";
document.getElementById("emailA").href="mailto:ask@klo.lt?subject=（klo.lt-FCF）回饋信件&body=內容類型：（問題？建議？）%0A細節：（越詳細越好）";
