final_title_str="klo.lt - FNF《新資料夾》播放室";
final_root_path="https://klo.lt/fnf/";
final_artist_str="新資料夾";
channel="fnf";

document.getElementById("aboutA").href="https://github.com/SotongDJ/klo.lt";
document.getElementById("emailA").href="mailto:ask@klo.lt?subject=（klo.lt-FNF）回饋信件&body=內容類型：（問題？建議？）%0A細節：（越詳細越好）";
